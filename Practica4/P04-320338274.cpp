...
int main()
{
	...
	CrearCilindro(10000, 0.75f);//índice 2 en MeshList
	...
	*/
	...
	glm::mat4 modelaux1(1.0);//Inicializar matriz de Modelo 4x4
	glm::mat4 modelaux2(1.0);//Inicializar matriz de Modelo 4x4
	...
	//	meshList[0]->RenderMesh(); //dibuja cubo y pirámide triangular
		...
		modelaux = modelaux1 = modelaux2 = model;
		model = glm::scale(model, glm::vec3(17.0f, 6.0f, 6.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.553f, 0.553f, 0.553f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color)); //para cambiar el color del objetos
		meshList[0]->RenderMesh();

		// PATA 1

		// Articulacion 1 pata 1
		model = modelaux;
		model = glm::translate(model, glm::vec3(5.5f, -2.5f, 3.0f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion1()), glm::vec3(0.0f, 0.0f, 1.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(1.0f, 0.0f, 0.0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color)); //para cambiar el color del objetos
		...
		// pata 1 primera parte
		model = glm::translate(model, glm::vec3(0.0f, -1.3f, 1.0f));
		modelaux = model;
		model = glm::rotate(model, glm::radians(-40.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		model = glm::scale(model, glm::vec3(2.2f, 5.0f, 2.2f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.653f, 0.653f, 0.653f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color)); //para cambiar el color del objetos
		meshList[2]->RenderMeshGeometry();

		// articulation 2 pata 1
		model = modelaux;
		model = glm::translate(model, glm::vec3(0.0f, -1.9f, 1.7f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion2()), glm::vec3(0.0f, 0.0f, 1.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(1.0f, 0.0f, 0.0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color)); //para cambiar el color del objetos
		...
		// pata 1 parte 2
		model = glm::translate(model, glm::vec3(0.0f, -2.9f, 0.2f));
		model = glm::scale(model, glm::vec3(2.2f, 5.0f, 2.2f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.653f, 0.653f, 0.653f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color)); //para cambiar el color del objetos
		...
		model = glm::scale(model, glm::vec3(1.5f, 0.2f, 2.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		modelaux = model;
		model = glm::scale(model, glm::vec3(5.0f, 6.1f, 6.1f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.453f, 0.453f, 0.453f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color)); //para cambiar el color del objetos
		meshList[0]->RenderMesh();

		// pico arriba
		model = modelaux;
		model = glm::translate(model, glm::vec3(-3.0f, -2.4f, 0.0f));
		model = glm::scale(model, glm::vec3(10.1f, 1.0f, 5.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.347f, 0.165f, 0.165f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color)); //para cambiar el color del objetos
		meshList[0]->RenderMesh();
		...
		// pico abajo
		model = modelaux;
		model = glm::translate(model, glm::vec3(-3.0f, -0.9f, 0.0f));
		model = glm::scale(model, glm::vec3(10.1f, 1.0f, 5.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.347f, 0.165f, 0.165f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color)); //para cambiar el color del objetos
		...
		//  ojo izquierdo
		model = modelaux;
		model = glm::translate(model, glm::vec3(-2.5f, 1.3f, -1.5f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		// oreja derecho
		model = modelaux;
		model = glm::translate(model, glm::vec3(-0.5f, 1.3f, 3.5f));
		...
		// gorrito de cumpleanos
		model = modelaux;
		model = glm::translate(model, glm::vec3(0.0f, 3.5f, 0.0f));
		model = glm::scale(model, glm::vec3(1.2f, 4.5f, 1.5f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		// antena
		model = modelaux;
		model = glm::translate(model, glm::vec3(-2.0f, 5.0f, 2.2f));
		...
		// articulacion cola
		model = modelaux2;
		model = glm::translate(model, glm::vec3(8.0f, 1.1f, 0.0f));
