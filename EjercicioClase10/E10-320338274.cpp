...
float reproduciranimacion, habilitaranimacion, guardoFrame, reinicioFrame, ciclo, ciclo2, ciclo3, ciclo4, ciclo5, ciclo6, ciclo7, ciclo8, contador = 0;
...
{
	std::ifstream file("keyframes_helicoptero.txt");



	while (file >> KeyFrame[FrameIndex].movAvion_x
		>> KeyFrame[FrameIndex].movAvion_y
		>> KeyFrame[FrameIndex].giroAvion
		>> KeyFrame[FrameIndex].movAvion_xInc
		>> KeyFrame[FrameIndex].movAvion_yInc
		>> KeyFrame[FrameIndex].giroAvionInc) {
		FrameIndex++;
	}
...
void saveFrame(void) //tecla L
{
	...
	std::ofstream file("keyframes_helicoptero.txt", std::ios::app);
	if (file.is_open())
	{
		file << movAvion_x << " " 
		     << movAvion_y << " " 
...
int main()
{
	...
	printf("7.-Presiona 3 para rotar\n8.-Presiona 4 para habilitar rotar\n");
	printf("9.-Presiona 5 para bajar en y\n10.-Presiona 6 para habilitar bajar en y\n");
	printf("11.-Presiona 7 para subir en y\n10.-Presiona 8 para habilitar subir en y\n");
