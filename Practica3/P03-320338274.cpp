...
// Función para crear aristas de la pirámide triangular
void CrearAristas()
{
	GLfloat fac = sqrt(3);
	GLfloat altura = sqrt(2) / fac;
	...
	// Vertices de la pirámide triangular
	...
	// Definición de las aristas de la pirámide
	...
	for (int e = 0; e < 6; e++) {
		...
		// Crear los 8 vértices del prisma rectangular que representa la arista
		...
		// Índices para formar las caras del prisma (linea con mas grosor)
...
int main()
{
	...
	CrearPiramideTriangular(colorRojo, colorVerde, colorAzul, colorRandom);//índice 0 en MeshListColor
	CrearPiramideTriangular(colorNegro, colorNegro, colorNegro, colorNegro);//índice 1 en MeshListColor
